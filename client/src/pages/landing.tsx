      ...
      <main className='pt-16'>
                        ...
                        >
                          {item.type === 'folder' ? (
                            ...
                            <span className='text-xs font-medium uppercase'>
                              {item.type === 'pdf' ? 'PDF' : item.type === 'excel' ? 'XLS' : 'PPT'}
                            </span>
                          )}
                        </div>
              ...
              {[
                {
                  ...
                  title: 'Cloud Storage',
                  description:
                    'Store all your files securely in the cloud with unlimited organization options.',
                },
                {
                  icon: FolderOpen,
                  title: 'Folder Organization',
                  description:
                    'Create folders and subfolders to keep your files organized and easy to find.',
                },
                {
                  icon: Share2,
                  title: 'Easy Sharing',
                ...
                },
                {
                  ...
                  description:
                    'All files are encrypted in transit and at rest using industry-standard encryption.',
                },
                {
                  icon: Zap,
                  title: 'Fast Uploads',
                  description:
                    'Lightning-fast upload speeds with support for large files up to 10GB.',
                },
              ].map((feature, i) => (
        ...
        <section id='security' className='py-24'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='grid lg:grid-cols-2 gap-12 items-center'>
              <div>
                <h2 className='text-3xl sm:text-4xl font-bold mb-6'>Enterprise-grade security</h2>
                <p className='text-lg text-muted-foreground mb-8'>
                  Your data security is our top priority. We use the latest security measures to
                  ensure your files are always protected.
                </p>
