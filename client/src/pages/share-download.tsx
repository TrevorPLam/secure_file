        ...
        <Card className='w-full max-w-md'>
          {isLoading ? (
            ...
            <CardContent className='py-16 text-center'>
              ...
              <CardDescription>This share link is invalid or has been deleted.</CardDescription>
            </CardContent>
          ) : shareInfo?.isExpired ? (
            <CardContent className='py-16 text-center'>
              <div className='w-16 h-16 rounded-full bg-destructive/10 mx-auto flex items-center justify-center mb-4'>
            ...
            <>
              <CardHeader className='text-center'>
                <div
                  className={`w-16 h-16 rounded-xl mx-auto flex items-center justify-center mb-4 ${colorClass}`}
                >
              ...
              <CardFooter className='justify-center'>
                <p className='text-xs text-muted-foreground'>
                  Downloaded {shareInfo.downloadCount} time
                  {shareInfo.downloadCount !== 1 ? 's' : ''}
                </p>
              </CardFooter>
            </>
          ) : null}
