...
describe("server/routes", () => {
  ...
  describe("GET /api/folders", () => {
    it("should return folders for authenticated user", async () => {
      const mockFolders = [
        { id: "1", name: "Folder 1", userId: "test-user-123", parentId: null, createdAt: new Date() },
      ];
    ...
    it("should return folders with parentId", async () => {
      const mockFolders = [
        { id: "2", name: "Subfolder", userId: "test-user-123", parentId: "parent-1", createdAt: new Date() },
      ];
      (storage.getFoldersByParent as any).mockResolvedValue(mockFolders);
  ...
  describe("GET /api/folders/path/:folderId", () => {
    it("should return folder path for owned folder", async () => {
      const mockFolder = { id: "folder-1", name: "My Folder", userId: "test-user-123", parentId: null };
  ...
  describe("GET /api/files", () => {
    it("should return files for authenticated user", async () => {
      const mockFiles = [
        { id: "1", name: "file1.pdf", userId: "test-user-123", folderId: null, size: 1024, mimeType: "application/pdf", objectPath: "/obj/1" },
      ];
    ...
    it("should return files in specific folder", async () => {
      const mockFiles = [
        { id: "2", name: "file2.pdf", userId: "test-user-123", folderId: "folder-1", size: 2048, mimeType: "application/pdf", objectPath: "/obj/2" },
      ];
      (storage.getFilesByFolder as any).mockResolvedValue(mockFiles);
